...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		KC_KP_0, KC_KP_3, KC_KP_6, KC_KP_9, KC_BSPACE, KC_Y, KC_U, KC_I, KC_O, KC_P,
		KC_KP_DOT, KC_KP_2, KC_KP_5, KC_KP_8, KC_G, KC_H, KC_J, KC_K, KC_L, KC_ENTER,
		KC_KP_0, KC_KP_1, KC_KP_4, KC_KP_7, KC_DELETE, KC_MPLY, KC_PSCREEN, KC_N, KC_M, KC_COMM, KC_DOT, KC_BSPACE,
